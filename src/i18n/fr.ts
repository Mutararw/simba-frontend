...
const fr: Dict = {
  ...
  contact: {
    ...
    boxTitle: "Tapez pour partager vos pensées",
  ...
  route: {
    ...
    popupTitle: "Vous planifiez une visite ?",
    popupText: "Vous allez à {{name}}. Comment souhaitez-vous procéder ?",
    shopInStore: "Acheter en magasin",
    shopInStoreSub: "Parcourir le catalogue maintenant",
    placePickup: "Passer une commande à retirer",
    placePickupSub: "Commandez en ligne, retirez sur place",
