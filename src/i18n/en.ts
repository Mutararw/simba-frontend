const en = {
  ...
  contact: {
    ...
    subtitle: "Did you face any challenges while shopping? Whatever it is — we want to know!",
    boxTitle: "Tap to share your thoughts",
    boxSubtitle: "There's a little surprise waiting inside — your voice matters to us!",
    formTitle: "Send us your feedback",
    formSubtitle: "We read every message",
    nameLabel: "Your name",
    emailLabel: "Email (optional)",
    messageLabel: "Your message",
    submit: "Send feedback",
    thanksTitle: "Thank you for your feedback!",
    thanksSubtitle: "Your message means a lot to us. We'll use it to make Simba better!",
  },
  route: {
    ...
    popupTitle: "Planning a visit?",
    popupText: "You're heading to {{name}}. How would you like to proceed?",
    shopInStore: "Shop in store",
    shopInStoreSub: "Browse the catalogue now",
    placePickup: "Place a pickup order",
    placePickupSub: "Order online, pick up there",
    close: "I'm just looking at the route for now",
  },
  checkout: {
