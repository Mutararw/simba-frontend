    ...
    <div className="container py-6">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="mt-4 border-t border-border pt-4">
            <h3 className="font-bold mb-3">Share Product</h3>
            <div className="flex flex-wrap gap-2">
              <Button
                variant="outline"
                size="sm"
                className="rounded-full gap-2 text-xs font-semibold hover:bg-green-50 dark:hover:bg-green-950/20 hover:text-green-600 border-green-200 dark:border-green-800"
                onClick={() => {
                  const text = `Check out ${translateProduct(product.name)} at Simba Supermarket: ${window.location.href}`;
              ...
              <Button
                variant="outline"
                size="sm"
                className="rounded-full gap-2 text-xs font-semibold hover:bg-blue-50 dark:hover:bg-blue-950/20 hover:text-blue-600 border-blue-200 dark:border-blue-800"
                onClick={() => {
              ...
              <Button
                variant="outline"
                size="sm"
                className="rounded-full gap-2 text-xs font-semibold hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-foreground border-border"
                onClick={() => {
                  const text = `Check out ${translateProduct(product.name)} at Simba Supermarket!`;
