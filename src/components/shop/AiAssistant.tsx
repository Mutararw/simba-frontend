...
const PLACEHOLDER_IMG = "https://placehold.co/200x200/e2e8f0/64748b?text=Simba";
                          ...
                          {msg.products.map((p) => (
                            ...
                            >
                              <div className="aspect-square w-full overflow-hidden rounded-lg bg-muted mb-2">
                                <img src={p.imageUrl || p.image || PLACEHOLDER_IMG} alt={p.name} className="h-full w-full object-cover" />
                              </div>
                                ...
                                <Button 
                                  ...
                                  onClick={() => {
                                    add({
                                      ...
                                      image: p.imageUrl || p.image || PLACEHOLDER_IMG
                                    });
