...
export const BRANCHES: Branch[] = [
  { id: "centenary", name: "Centenary House Branch", area: "Kiyovu (Town)", rating: 4.8, reviews: 521, hours: "07:00 – 23:00" },
  { id: "heights", name: "Kigali Heights Branch", area: "Kimihurura", rating: 4.9, reviews: 684, hours: "07:00 – 23:00" },
  { id: "gisozi", name: "Gisozi Branch", area: "Gisozi", rating: 4.6, reviews: 241, hours: "07:00 – 22:00" },
...
export const BRANCH_COORDS: Record<string, { lat: number; lng: number }> = {
  centenary: { lat: -1.9443, lng: 30.0617 },
  heights: { lat: -1.9511, lng: 30.0924 },
  gisozi: { lat: -1.9189, lng: 30.0756 },
